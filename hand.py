...
cap = cv2.VideoCapture(0, cv2.CAP_DSHOW) # 0 = default camera, CAP_DSHOW resolves terminating async callback error
while cap.isOpened():
    ...
    roi = frame[100:300, 100:300] # roi
    gray = cv2.cvtColor(roi, cv2.COLOR_BGR2GRAY) # converts to grayscale
    blur = cv2.GaussianBlur(gray, (35, 35), 0) # gaussian blur
    ...
    if l == 1:
        ...
        cv2.putText(frame, 'reposition', (10, 50), font, 2, (255, 255, 255), 3, cv2.LINE_AA)
